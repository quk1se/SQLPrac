...
--IF @time > '16:00:00:0' AND @time < '04:00:00:0' PRINT ('Äîáðûé âå÷åð')
--ELSE PRINT('Äîáðûé äåíü')
...
BEGIN
	...
	END
	UPDATE Casino_Data 
	SET money = @money, first_num = @first_num, second_num = @second_num, third_num = @third_num
	WHERE id_person = 1
END
